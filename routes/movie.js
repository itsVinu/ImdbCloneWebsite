...
router.get('/movie',async(req,res)=>{
    const upcoming_url = "https://api.themoviedb.org/3/movie/upcoming?api_key=3d812b53e8327e3496dbe05fb820cf0d"
    const uresponse = await axios.get(upcoming_url)

    const popular_url = "https://api.themoviedb.org/3/movie/popular?api_key=3d812b53e8327e3496dbe05fb820cf0d"
    const presponse = await axios.get(popular_url)

    const toprated_url = "https://api.themoviedb.org/3/movie/top_rated?api_key=3d812b53e8327e3496dbe05fb820cf0d"
    const topresponse = await axios.get(toprated_url)
    
    const nowplaying_url = "https://api.themoviedb.org/3/movie/now_playing?api_key=3d812b53e8327e3496dbe05fb820cf0d"
