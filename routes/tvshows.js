...
router.get('/tvshows',async(req,res)=>{
    const airing_today_url = `https://api.themoviedb.org/3/tv/airing_today?api_key=${process.env.API_KEY}`
    const on_the_air_url = `https://api.themoviedb.org/3/tv/on_the_air?api_key=${process.env.API_KEY}`
    const top_rated_url = `https://api.themoviedb.org/3/tv/top_rated?api_key=${process.env.API_KEY}`
    const populartv_url = `https://api.themoviedb.org/3/tv/popular?api_key=${process.env.API_KEY}`
